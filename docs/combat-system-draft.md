...
- на клетке есть корабли другого игрока с типом **не** `supply`.

Пустая клетка (в т.ч. под чужим контролем) и клетка **только** с кораблями снабжения противника — не бой. Нейтральная клетка без боевых кораблей — захват только снабжением.

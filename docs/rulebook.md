...
**Priority skip:** объявляется до броска, без оплаты фишками. Игрок пропускает **типы кораблей противника**: если он выиграет раунд, пропущенный тип у проигравшего дороже на **+1** к `destroyCost` (линкор 9→10) и уходит в конец своего tier.
